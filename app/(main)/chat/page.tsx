...
export default function ChatPage() {
  ...
  return (
    <div className="container mx-auto py-10 flex flex-col gap-6 h-screen justify-between">
      <div className="flex items-center justify-between mb-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow items-center">
        ...
        return (
          <AITool>
            ...
            <AIToolContent>
              <AIToolResult
                error={undefined}
                result={<BurnRate result={toolInvocation.result} />}
              />
            </AIToolContent>
          </AITool>
        );
